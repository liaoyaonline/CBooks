...
int MysqlUpload(BlInfo* uploadBL,BInfo * uploadB,char* uploadBS,char* TargetTable,char flag)
{
    ...
    case '1':
        printf("上传书本信息\n");
        sprintf(sql_insert, "INSERT INTO %s(BookId,BookName,BookAuthor,BookWordCount,Bookstatus,BookUpdata,BookScore,BookScoreCount,OneStarRate,TwoStarRate,ThreeStarRate,FourStarRate,FiveStarRate,BookClass,AddListCount,BookIntro) VALUES('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s');",TargetTable, uploadB->BookId,uploadB->BookName,uploadB->BookAuthor,uploadB->BookWordCount,uploadB->Bookstatus,uploadB->BookUpdata,uploadB->BookScore,uploadB->BookScoreCount,uploadB->OneStarRate,uploadB->TwoStarRate,uploadB->ThreeStarRate,uploadB->FourStarRate,uploadB->FiveStarRate,uploadB->BookClass,uploadB->AddListCount,uploadB->BookIntro);
        break;
    case '2':
        printf("上传书单信息\n");
        sprintf(sql_insert, "INSERT INTO %s(BooklistId,BooklistName,BooklistAuthor,BooklistViews,BooklistCount,BooklistKeep,BookType,BooklistUpdata,BooklistIntro) VALUES('%s','%s','%s','%s','%s','%s','%s','%s','%s');",TargetTable, uploadBL->BooklistId,uploadBL->BooklistName,uploadBL->BooklistAuthor,uploadBL->BooklistViews,uploadBL->BooklistCount,uploadBL->BooklistKeep,uploadBL->BookType,uploadBL->BooklistUpdata,uploadBL->BooklistIntro);
        printf("%s\n",sql_insert);
        break;
    case '3':
        printf("上传id\n");
